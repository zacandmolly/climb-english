...
test('mid-sentence pause under 1.5s does not split the sentence', () => {
  ...
  const words = [
    w(0.0, 'one'), w(0.3, 'of'), w(0.6, 'the'), w(0.9, 'golden'),
    w(1.2, 'rules'), w(1.5, 'is'), w(1.8, 'that'), w(2.1, 'two'),
    w(3.0, 'hands'), w(3.3, 'are'), w(3.6, 'better'), w(3.9, 'than'),
    w(4.2, 'one'),
  ];
...
test('sentence-ending punctuation still closes the sentence', () => {
  const words = [
    w(0.0, 'this'), w(0.3, 'was'), w(0.6, 'the'), w(0.9, 'top.'),
    w(2.5, 'It'), w(2.8, 'was'), w(3.1, 'blocked.'),
  ];
  const { sentences } = segmentWords(words);
...
test('pause longer than maxGapSeconds splits into a new sentence', () => {
  ...
  const words = [
    w(0.0, 'this'), w(0.3, 'was'), w(0.6, 'the'), w(0.9, 'top'),
    w(2.9, 'it'), w(3.2, 'was'), w(3.5, 'blocked'),
  ];
  const { sentences } = segmentWords(words);
...
test('short fragment with no punctuation merges into the previous sentence', () => {
  ...
  const words = [
    w(0.0, 'bring'), w(0.3, 'more'),
    w(1.1, 'power'), w(1.4, 'and'), w(1.7, 'strength'), w(2.0, 'to'), w(2.3, 'a'),
  ];
  const { sentences } = segmentWords(words);
...
test('regression: "get the last few / inches" merges instead of fragmenting', () => {
  ...
  const words = [
    w(0.0, 'just'), w(0.3, 'flexing'), w(0.6, 'your'), w(0.9, 'arm'),
    w(1.2, 'at'), w(1.5, 'the'), w(1.8, 'end'), w(2.1, 'to'),
    w(2.8, 'get'), w(3.1, 'the'), w(3.4, 'last'), w(3.7, 'few'),
    w(4.2, 'inches'),
  ];
  const { sentences } = segmentWords(words);
